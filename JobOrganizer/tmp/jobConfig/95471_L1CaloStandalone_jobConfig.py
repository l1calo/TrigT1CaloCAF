...
JobWorkingDir = "/afs/cern.ch/user/l/l1ccalib/w0/DaemonData/jobs/95471_L1CaloStandalone"
JobLogDir     = "/afs/cern.ch/user/l/l1ccalib/w0/DaemonData/jobs/95471_L1CaloStandalone/log"
JobRootDir    = "/afs/cern.ch/user/l/l1ccalib/w0/DaemonData/jobs/95471_L1CaloStandalone/root"
#JobPoolDir    = "/afs/cern.ch/user/l/l1ccalib/w0/DaemonData/jobs/95471_L1CaloStandalone/pool"
JobPoolDir    = ""
JobConfigDir  = "/afs/cern.ch/user/l/l1ccalib/w0/DaemonData/jobs/95471_L1CaloStandalone/config"
JobPostDir    = "/afs/cern.ch/user/l/l1ccalib/w0/DaemonData/jobs/95471_L1CaloStandalone/post"
...
#jo name
JobOptionName    = "95471_L1CaloStandalone_jobOptions.py"

#Athena log file
AthenaJobLogFile = JobOptionName.strip("_jobOptions.py")+'Athena.log'

RawDataFileBasePaths = ["/castor/cern.ch/grid/atlas/DAQ/l1calo/00095471","/castor/cern.ch/grid/atlas/DAQ/l1calo/0095471", "/castor/cern.ch/grid/atlas/DAQ/l1calo/95471", "/castor/cern.ch/grid/atlas/DAQ/l1calo"]

LogLevel = 2

#AdditionalInputFiles = [("/afs/cern.ch/user/l/l1ccalib/w0/DaemonData/jobs/95471_L1CaloStandalone/config/",""),("/afs/cern.ch/user/l/l1ccalib/w0/DaemonData/jobs/95471_L1CaloStandalone/config/","config")]

#OutputFilesPath={"CBNT":JobRootDir, "POOL":JobPoolDir, "LOG":JobLogDir}
#OutputFiles = [ "cosmics.ntuple", "sdfsdf"]
OutputFiles = { "cosmics.ntuple.root":[(JobRootDir, "95471_L1CaloStandalone.ntuple.root")],
