...
JobWorkingDir = "/afs/cern.ch/user/l/l1ccalib/w0/DaemonData/jobs/94470_CBNT"
JobLogDir     = "/afs/cern.ch/user/l/l1ccalib/w0/DaemonData/jobs/94470_CBNT/log"
JobRootDir    = "/afs/cern.ch/user/l/l1ccalib/w0/DaemonData/jobs/94470_CBNT/root"
#JobPoolDir    = "/afs/cern.ch/user/l/l1ccalib/w0/DaemonData/jobs/94470_CBNT/pool"
JobPoolDir    = ""
JobConfigDir  = "/afs/cern.ch/user/l/l1ccalib/w0/DaemonData/jobs/94470_CBNT/config"
JobPostDir    = "/afs/cern.ch/user/l/l1ccalib/w0/DaemonData/jobs/94470_CBNT/post"
...
#jo name
JobOptionName    = "94470_CBNT_jobOptions.py"

#Athena log file
AthenaJobLogFile = JobOptionName.strip("_jobOptions.py")+'Athena.log'

RawDataFileBasePaths = ["/castor/cern.ch/grid/atlas/DAQ/l1calo/0094470", "/castor/cern.ch/grid/atlas/DAQ/l1calo/94470", "/castor/cern.ch/grid/atlas/DAQ/l1calo"]

LogLevel = 2

#AdditionalInputFiles = [("/afs/cern.ch/user/l/l1ccalib/w0/DaemonData/jobs/94470_CBNT/config/",""),("/afs/cern.ch/user/l/l1ccalib/w0/DaemonData/jobs/94470_CBNT/config/","config")]

#OutputFilesPath={"CBNT":JobRootDir, "POOL":JobPoolDir, "LOG":JobLogDir}
#OutputFiles = [ "cosmics.ntuple", "sdfsdf"]
OutputFiles = { "cosmics.ntuple.root":[(JobRootDir, "94470_CBNT.ntuple.root")],
